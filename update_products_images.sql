-- ============================================================
-- Sahabat Mebel — Update Product Images to match generated assets
-- Run this in phpMyAdmin or via MySQL CLI
-- ============================================================
USE furnihome;

-- Update image filenames for existing products
...
-- Update product names & descriptions to Indonesian (sesuai nama & foto produk)
UPDATE products SET
